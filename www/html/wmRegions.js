...
const wmRegions = {
	...
	"maps": [ {'url': 'lib/gadm41_USA/gadm41_USA_2.quantized.json', 'feature': 'gadm41_USA_2'} ],
	'POIs': [
	    [[-122.1976, 41.4106], "Mt Shasta"],
	    [[-122.3904, 40.5836], "Redding"],
	    [[-122.2342, 40.1766], "Red Bluff"],
	    [[-121.5052, 40.4874], "Mt Lassen"],
	    [[-124.4096, 40.4383], "Cape Mendocino"],
	    [[-121.4936, 38.5766], "Sacramento"],
	    //[[-121.2932, 37.9548], "Stockton"],
	    [[-119.7893, 36.7362], "Fresno"],
	    [[-119.3011, 36.3296], "Visalia"],
	    [[-119.0188, 35.3733], "Bakersfield"],
	    [[-120.2078, 39.3232], "Truckee"],
	    [[-119.7748, 39.5059], "RNO"],
	    [[-119.7605, 39.0105], "Minden"],
	    [[-118.2558, 37.6341], "White Mt Pk"],
	    [[-119.5919, 37.7490], "Yosemite"],
	    [[-118.2923, 36.5786], "Mt Whitney"],
	    [[-123.7360, 38.9530], "Pt Arena"],
	    [[-122.1058, 38.3995], "Mt Vaca"],
	    [[-122.5963, 37.9235], "Mt Tam"],
    ...
    "CentralCalNAM": {
	'model': 'NAM',
	'url': 'data/NOAA/NAM/CentralCal-NAM',
	"maps": [ {'url': 'lib/gadm41_USA/gadm41_USA_2.topojson', 'feature': 'gadm41_USA_2'} ],
	'dpParams': {
	    'rotate': [0, 0],
	    'center': [-122.0,38.5],
	...
	'POIs': [
	    ...
	    [[-121.4941, 38.0370], "Tinsley", "red"],
	    [[-121.4936, 38.5766], "Sacramento"],
	    [[-120.9984, 37.6419], "Modesto"],
	    [[-120.4834, 37.3025], "Merced"],
	    [[-119.7893, 36.7376], "Fresno"],
	    [[-119.5329, 37.7463], "Half Dome"],
	    [[-119.0333, 37.6314], "Mammoth"],
	    //[[-122.2779, 37.0946], "Waddell Creek"],
	    [[-122.0019, 36.9606], "Santa Cruz", "red"],
	    [[-121.8898, 36.6020], "Monterey", "red"],
	    //[[-121.9345, 36.6376], "Pt Pinos"],
	    [[-120.2078, 39.3232], "Truckee"],
    [[-119.7748, 39.5059], "RNO"],
    [[-119.7605, 39.0105], "North Sails Minden"],
