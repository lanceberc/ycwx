...
proj_usa_lambert_conformal_conic = "+proj=lcc +lon_0=-96 +lat_0=38 +lat_1=33 +lat_2=45"
...
regions = {}
regions["Atlantic"] = {"arg": "atlantic",
                       "desc": "GOES-16 North Atlantic",
                       "sfc": "M:/NOAA/OPC/atlantic",
                       ...
                       #"starttime": "202101010000",
                       "starttime": "202201010000",
                       "goes": "16",
                       "sat": goes16,
                       "res": "2k",
                       "sector": "FD",
                       "dest_srs": proj_mercator,
...
regions["Pacific"] = {"arg": "pacific",
                      "desc": "GOES-17 North Pacific",
                      "sfc": "M:/NOAA/OPC/pacific",
                      ...
                      "res": "2k",
                      "sector": "FD",
                      #"starttime": "202101010300",
                      "starttime": "202201010300",
                      "interestArea": [-225, 16, -115, 65], # lat/long of ur, ll corner of Surface Analysis
                      "dest_srs": proj_anti_mercator,
                      "sfcanalysisArea": (0, 8, 2441, 1564), # Cut off top 8 and bottom 36 pixels
                      "crop": (2441-2160, 1488-1215, 2441, 1488),
...
regions["Eddy"] = {"arg": "eddy",
                   "desc": "GOES-17 PACUS Catalina Eddy",
                   "sfc": None,
                   ...
                   "dest_srs": proj_anti_mercator,
                   "logos": [{"fn": "rammb_logo.png"}, {"fn": "NOAA_logo.png"}],
                   "logopos": "left",
...
regions["Karl"] = {"arg": "karl",
                   "desc": "GOES-17 PACUS SF Bay Area",
                   "sfc": None,
                   "nesdisdir": "M:/NASA/NESDIS_CONUS-West",
                   "dest": "M:/NASA/Karl",
                   "goes": "17",
                   ...
                   "res": "1k",
                   "sector": "CONUS",
                   "interestArea": [-125.20, 36.50, -120.50, 39.00], # lat/long of ll, ur corners
                   "dest_srs": proj_anti_mercator,
                   "logos": [{"fn": "rammb_logo.png"}, {"fn": "NOAA_logo.png"}],
                   "logopos": "left",
                   "sfcanalysisArea": (0, 0, 1280, 720),
                   ...
                   "oFormat": "jpg",
                   "oRes": (1280, 720),
                   "starttime": "202201011800",
                   # "starttime": "202107160000",
                   # "endtime":   "202107160030",
}

regions["Karl2"] = {"arg": "karl2",
                   "desc": "GOES-17 PACUS SF Bay Area",
                   "sfc": None,
                   "nesdisdir": "M:/NASA/NESDIS_CONUS-West",
                   "dest": "M:/NASA/Karl2",
                   ...
                   "res": "1k",
                   "sector": "CONUS",
                   "interestArea": [-125.00, 36.50, -120.20, 39.00], # lat/long of ll, ur corners
                   "dest_srs": proj_anti_mercator,
                   "logos": [{"fn": "rammb_logo.png"}, {"fn": "NOAA_logo.png"}],
                   "logopos": "left",
                   "sfcanalysisArea": (0, 0, 1280, 720),
                   ...
                   "oFormat": "jpg",
                   "oRes": (1280, 720),
                   "starttime": "202006101500",
}

regions["Arthur"] = {"arg": "",
                     "desc": "Hurricane Arthur",
                     "sfc": None,
                     ...
                     "res": "1k",
                     "sector": "CONUS",
                     "interestArea": [-88.75, 23.0, -65.0, 38.0], # lat/long of ll, ur corner of Surface Analysis
                     "dest_srs": proj_mercator,
                     #"dest_srs": proj_usa_lambert_conformal_conic,
                     "logos": [{"fn": "rammb_logo.png"}, {"fn": "NOAA_logo.png"}],
                     "starttime": "202005152100",
                     "sfcanalysisArea": (0, 0, 1280, 720),
                     "crop": (0, 0, 1280, 720),
                     "oFormat": "png",
                     "oRes": (1280, 720),
...
regions["Snowcal"] = {"arg": "snocal",
                      "desc": "GOES-17 PACUS West Coast Storms",
                      "sfc": None,
                      "nesdisdir": "M:/NASA/NESDIS_CONUS-West",
                      "ciramapdir": "M:/NASA/CIRA_Cali-FD/map",
                      "ciramapts": "20181115150038",
...
regions["CaliCoast"] = {"arg": "coast",
                        "desc": "GOES-17 PACUS California SF-SD Coast",
                        "sfc": None,
                        "nesdisdir": "M:/NASA/NESDIS_CONUS-West",
...
regions["SEStorm202004"] = {"arg": "sestorm",
                            "desc": "GOES-17 CONUS East Coast Storm",
                            "sfc": None,
                            "nesdisdir": "M:/NASA/NESDIS_CONUS-East",
                            "dest": "M:/NASA/2020-04_SEStorm",
                            "goes": "16",
                            "sat": goes16,
                            "res": "1k",
                            "sector": "CONUS",
                            "interestArea": [-102.50, 24.50, -63.00, 44.50], # lat/long of ll, ur corner of Surface Analysis
                            "dest_srs": proj_mercator,
                            "logos": [{"fn": "rammb_logo.png"}, {"fn": "NOAA_logo.png"}],
                            "logopos": "right",
                            "tz": "EDT",
                            "starttime": "202004111600",
                            "sfcanalysisArea": (0, 0, 1280, 720),
                            "crop": (0, 0, 1280, 720),
                            "oFormat": "jpg",
                            "oRes": (1280, 720),
...
regions["202001_Midwest"] = {"arg": "midwest",
                             "desc": "GOES-16 CONUS Midwest Squalls",
                             "sfc": None,
                             "nesdisdir": "M:/NASA/NESDIS_CONUS-East",
                             "dest": "M:/NASA/2020-01_Midwest",
                             "goes": "16",
                             "sat": goes16,
                             "res": "1k",
                             "sector": "CONUS",
                             "interestArea": [-111.50, 25.50, -81.50, 41.00],
                             "dest_srs": proj_usa_lambert_conformal_conic,
                             "logos": [{"fn": "cira18Logo.png"}, {"fn": "goesRDecalSmall.png"}],
                             "logopos": "left",
                             "tz": "EST",
                             "starttime": "202001101600",
                             "sfcanalysisArea": (0, 0, 1280, 720),
                             "crop": (0, 0, 1280, 720),
                             "oFormat": "jpg",
                             "oRes": (1280, 720),
...
regions["Hamptons"] = {"arg": "hamptons",
                       "desc": "GOES-16 CONUS Hamptons",
                       "sfc": None,
                       "nesdisdir": "M:/NASA/NESDIS_CONUS-East",
                       "dest": "M:/NASA/Hamptons",
                       "goes": "16",
                       "sat": goes16,
                       "res": "1k",
                       "sector": "CONUS",
                       "interestArea": [-74.15, 40.15, -69.15, 42.75],
                       "dest_srs": proj_mercator,
                       "logos": [{"fn": "cira18Logo.png"}, {"fn": "goesRDecalSmall.png"}],
                       "logopos": "right",
                       "tz": "EDT",
                       "starttime": "202005250800",
                       "endtime": "202005260300",
                       "sfcanalysisArea": (0, 0, 1280, 720),
                       "crop": (0, 0, 1280, 720),
                       "oFormat": "jpg",
                       "oRes": (1280, 720),
...
def goeswarp(region, fn):
    ...
    logging.debug("geotransform %s" % (r["geotransform"]))
    logging.debug("dstSRS %s" % (r["dest_srs"]))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-region", choices=choices, help="Overlay region", required=True)
    ...
    overlay(choicemap[args.region], args.cira, args.nesdis, not args.norequiremap)
